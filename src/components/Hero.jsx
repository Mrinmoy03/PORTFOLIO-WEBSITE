  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center isolate">
      ...
      <div className="flex flex-col md:items-center items-start xl:gap-y-10 gap-y-3 xl:mb-0 md:mb-20 mb-0">
        <h1 className="flex flex-col xl:space-y-8 md:space-y-4 space-y-2 xl:text-6xl md:text-4xl text-3xl md:font-normal font-bolder ">
          <span className="flex ">
            {letters.map((letter, index) => (
              <span
                key={index}
                className="inline-block md:w-38 w-32 xl:-mr-13 -mr-20  relative cursor-pointer"
        ...
        <button
          className="xl:w-[400px] md:w-[300px] bg-gray-900 dark:bg-gray-200 md:py-1 py-0 md:px-4 px-2 xl:text-2xl md:text-xl text-base  text-white dark:text-gray-900 tracking-widest rounded-r-3xl flex justify-between items-center md:mr-auto md:mx-0 mx-auto transition-colors duration-500"
        ...
        <div className="flex md:gap-12 gap-2 mr-auto">
          {socialIcons.map((social, index) => (
            <a
              ...
              className="xl:text-3xl md:text-2xl text-xl text-red-500 dark:text-yellow-500 dark:hover:text-white hover:text-gray-900 transition-colors duration-500"
            >
        ...
        <div className="lg:w-[600px] md:w-[500px] w-[350px] absolute left-1/2 -translate-x-1/2 -z-10">
          ...
          />
          <span
  className="animate-bounceRotate xl:text-xs md:text-[10px] text-[8px] font-bold tracking-wide  absolute -top-5 xl:right-24 lg:right-28 md:right-16 right-10"
>
